...
#[derive(Debug)]
pub struct GhostCMSProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GhostCMSProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GhostCMS processing");
    
    let mut processor = GhostCMSProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GhostCMSProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GhostCMSProcessor::new(false);
